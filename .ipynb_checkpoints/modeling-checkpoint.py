...
tickerStrings = ['^GSPC', '^IXIC', '^RUT', 'EEM', 'EMXC', 'EEMA', 'VTHR', 'SLQD', 'VNQI', 'VYMI']
df_list = list()
...
df.columns = ['EEM', 'EEMA', 'EMXC', 'Nasdaq', 'Russel', 'Spx', 'VTHR', 'SLQD', 'VNQI', 'VYMI']
...
asset_list = ['Spx', 'Nasdaq', 'Russel', 'EMXC', 'EEMA', 'EEM', 'VTHR', 'SLQD', 'VNQI', 'VYMI']
...
t_df = df.copy()
t_df.rename(columns={'VYMI_ret':'target'}, inplace=True)
